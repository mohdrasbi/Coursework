...
int evenBits(void) {
  /*
  1. start with 01010101 (85 in decimal) which sets even-numbered bits to 1.
  2. do left shift by 8 (will have now 0101010100000000)
  3. use & with 01010101 to let all even-numbered bits equal 1.
  4. repeat again with 16
  */
  int word = 0x55;
  word = word | word << 8;
...
int divpwr2(int x, int n) {
   ...
   /*for positive return x >> n
   for negative return x + pwr - 1 >> n
   need to check for positive and negative
   */

   int check = x >> 31; //all 1s if neg and all 0s af pos
